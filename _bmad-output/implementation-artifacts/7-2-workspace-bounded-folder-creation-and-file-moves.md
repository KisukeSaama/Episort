...
1. Given an approved immutable operation plan exists
...
Review `6-1-execution-eligibility-and-approved-plan-locking.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
