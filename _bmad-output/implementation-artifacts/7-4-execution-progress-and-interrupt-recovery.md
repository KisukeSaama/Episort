...
1. Given an approved execution is in progress
...
Review `6-3-per-file-execution-results-and-failure-handling.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
