...
1. Given the detected pattern has been validated
...
Review `5-2-specials-and-movie-destination-naming.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
