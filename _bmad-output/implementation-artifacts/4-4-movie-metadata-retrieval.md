...
1. Given a TVDB movie identity is selected
...
Review `3-3-series-metadata-retrieval-and-episode-orders.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
