...
1. Given review items have been inspected or corrected
...
Review `4-3-manual-match-and-status-correction.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
