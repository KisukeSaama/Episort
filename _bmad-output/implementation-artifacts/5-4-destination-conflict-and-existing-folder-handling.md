...
1. Given an operation plan is generated
...
Review `5-3-workspace-bounded-operation-plan-generation.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
