...
1. Given TVDB candidates are available for a detected group or movie
...
Review `3-1-tvdb-series-and-movie-candidate-search.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
