...
Review `6-2-workspace-bounded-folder-creation-and-file-moves.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
