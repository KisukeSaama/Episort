...
1. Given the selected folder contains subtitles, `.nfo` files, images, unsupported videos, or disk images
...
Review `2-1-supported-media-file-detection.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
