...
1. Given media inventory exists
...
Review `7-2-single-bundled-model-enforcement.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
