...
1. Given inventory items and TVDB metadata are available
   When matching runs
   ...
   And local AI from Epic 3 may contribute confidence scoring or tie-breaking but never overrides TVDB identity
...
Review `3-4-movie-metadata-retrieval.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
