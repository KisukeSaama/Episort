...
Review `1-4-workspace-bounded-input-folder-selection.md` before implementation. Reuse its established file locations, test patterns, and decisions; do not duplicate or contradict them.
