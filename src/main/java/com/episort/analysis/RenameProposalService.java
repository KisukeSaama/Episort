...
public final class RenameProposalService {
    ...
    /**
     * Strips everything Windows refuses in a file name: reserved characters,
     * control characters, and trailing dots or spaces — the last two are
     * silently dropped by the filesystem, which would make the file land under a
     * name the plan never showed the user.
     */
