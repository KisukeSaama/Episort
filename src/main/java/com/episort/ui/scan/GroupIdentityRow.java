 ...
 * it holds, and the TVDB identity that will name them.
 *
 * @param groupName    the seed the scanner grouped the files under
 * @param fileCount    how many files carry that identity
 * @param identityText the TVDB identity as shown to the user, or a placeholder
 * @param stateText    how the identity was obtained (automatic, suggested, manual)
 * @param resolved     false when no TVDB identity was found at all
