...
/**
 * Aggregated outcome of the post-scan batch TMDB resolution. One
 ...
 * pass.
 */
public record TmdbBatchMatchResult(Map<String, GroupMatch> matchesBySeed, List<String> errors) {

    public TmdbBatchMatchResult {
        matchesBySeed = matchesBySeed == null ? Map.of() : Map.copyOf(matchesBySeed);
        errors = errors == null ? List.of() : List.copyOf(errors);
    }

    public static TmdbBatchMatchResult empty() {
        return new TmdbBatchMatchResult(Map.of(), List.of());
    }
    ...
    public record GroupMatch(
            ...
            Optional<TmdbSeriesDetails> series,
            Optional<TmdbMovieDetails> movie,
            Optional<TmdbCandidate> candidate,
